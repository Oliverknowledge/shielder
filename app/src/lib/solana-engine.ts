  ...
  return {
    ...
    actions(signer, usdc): Actions {
      ...
      return {
        ...
        commitLadder: () => { throw new Error("The risk ladder is part of ShieldVault.sol v3; the Solana v0 program does not have it."); },
        setReducedTier: () => { throw new Error("No ladder on Solana v0."); },
        proposeLadderChange: () => { throw new Error("No ladder on Solana v0."); },
        executeLadderChange: () => { throw new Error("No ladder on Solana v0."); },
        cancelLadderChange: () => { throw new Error("No ladder on Solana v0."); },
