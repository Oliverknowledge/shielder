...
export const RULES: RuleDef[] = [
  ...
  { key: "daily", name: "Daily reload", kind: "usd", strictIsHigher: false, current: (v) => rawToNumber(v.velocityThreshold), before: "Release at most ", after: " to my trading account in any 24 hours.", why: "Added up across every release inside a rolling 24 hours. Your floor is the harder backstop: nothing can take the treasury below it except a full exit, after its delay." },
