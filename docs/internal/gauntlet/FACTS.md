...
| `0x83144b99D89947703714Ee9aA3A3614985041D2B` | the Privy embedded wallet | **Correction (2026-09-13, read back from chain): it DOES have a v3 vault** — floor **$8,050**, balance **$0**, $225/24h, $600 trigger. The wallet holds $20 test USDC + 0.3 HYPE. Depositing that $20 leaves $0 releasable (floor > balance) and lowering the floor waits 24h, so **do not deposit from it on camera** (`docs/DEMO_SCRIPT.md`, prep note 5). Its v1 vault ($45) and v1 txs remain the Privy evidence |
